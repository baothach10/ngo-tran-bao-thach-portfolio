        ...
        <section className="beyond-work-container">
            ...
            <div className="beyond-work-content">
                <p className="beyond-work__paragraph">
                    When I'm not coding, you'll find me exploring new technologies, mentoring aspiring developers and students.
                    I believe in continuous learning and giving back to the community that has supported my growth.
                </p>
                <p className="beyond-work__paragraph">
                    I'm also passionate about traveling and playing sports like basketball, swimming, going to the gym and so on.
                    These activities help me maintain a fresh perspective and bring creative energy to my work.
                </p>
                <p className="beyond-work__paragraph">
                    My background in both AI and web development gives me a unique perspective on developing projects with AI integration.
                    I understand the challenges and opportunities from multiple angles, which helps me create solutions that are both beautiful and functional.
                </p>
            </div>
